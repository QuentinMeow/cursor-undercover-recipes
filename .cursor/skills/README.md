...
| `launch-cursor-autoapprove` | Launch a dedicated, verified IDE Cursor window with DOM auto-accept plus bounded nested/pinned-agent recovery injected via CDP. Includes gate and cycling controls. |
